...
def send_email(send_from, send_to, subject, text, files=None):
    ...
    smtp.starttls()
    smtp.login(send_from, '') #add password
...
if __name__ == "__main__":
    ...
    send_email('falaxana511@gmail.com',['lacsamana.franco@gmail.com'], 'Jobs Posting', 'Please, find attached a list of job posting to this email.',files=['remote_jobs.xls'])